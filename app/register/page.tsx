...
export default function RegisterPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        console.log({ fullName, email, contact, password, confirmPassword, agreeTerms });
    };
        ...
        <div className="min-h-screen flex bg-[#f5f5f5] py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full mx-auto space-y-8 bg-white p-8 rounded-lg shadow-lg">
                ...
                <div className="text-center">
                    ...
                    <h2 className="mt-6 text-3xl font-extrabold text-[#34495e]">Create your account</h2>
                    <p className="mt-2 text-sm text-gray-500">
                        Or
                        <br />
                        <Link href="/login" className="font-normal" style={{ color: colors.primary.main }}>
